...
static NSString *nameOfDB = @"unstabud";
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:nameOfDB withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSString *dbName = [NSString stringWithFormat:@"%@.sqlite", nameOfDB];
